...
public class Ausgabe implements IComponente {
    ...
    public void setzeGroesse(double neueBreite, double neueHoehe) {
        setzeGroesse((int) neueBreite, (int) neueHoehe);
    }
    ...
    public void setzePosition(double neuesX, double neuesY) {
        setzePosition((int) neuesX, (int) neuesY);
    }
    ...
    public void setzeDimensionen(double neuesX, double neuesY, double neueBreite,
    double neueHoehe) {
        setzeDimensionen((int) neuesX, (int) neuesY, (int) neueBreite, (int) neueHoehe);
    }
